	...
	if(!$qc){
			...
			if(mysqli_num_rows($qc)== 0){
							print ("<table align='center' style=\"border:0px\">
									...
									Consulta Modificar CV : ".mysqli_num_rows($qc)." Resultados.
										</th>
									</tr>
...
<input name='sector' type='hidden' value='".$rowc['sector']."' />".ucwords($rowc['sector'])."
						</td>
													
						<td class='BorderInfDch' width='150px'>
<input name='sector2' type='hidden' value='".$rowc['sector2']."' />".ucwords($rowc['sector2'])."
						</td>
													
						<td class='BorderInfDch' width='150px'>
<input name='modalidad' type='hidden' value='".$rowc['modalidad']."' />".ucwords($rowc['modalidad'])."
						</td>
...
<input name='titulo' type='hidden' value='".$rowc['titulo']."' />".$rowc['titulo']."
						...
						<td class='BorderInfDch' align='left' width='350px'>
...
<input name='academia' type='hidden' value='".$rowc['academia']."' />".$rowc['academia']."
						...
						<td class='BorderInf' align='left' width='350px'>
	...
	if(!$qb){
			...
			if(mysqli_num_rows($qb)== 0){
							...
							show_form();	
									...
									<tr>
										<th colspan=10 class='BorderInf'>
								Todos los resultados : ".mysqli_num_rows($qb)." Resultados.
										</th>
									</tr>
...
<input name='horas' type='hidden' value='".$rowb['horas']."' />".$rowb['horas']."
						...
						<td class='BorderInfDch' width='150px'>
<input name='sector' type='hidden' value='".$rowb['sector']."' />".ucwords($rowb['sector'])."
						</td>	
												
						<td class='BorderInfDch' width='150px'>
<input name='sector2' type='hidden' value='".$rowb['sector2']."' />".ucwords($rowb['sector2'])."
						</td>
							
						<td class='BorderInfDch' width='150px'>
<input name='modalidad' type='hidden' value='".$rowb['modalidad']."' />".ucwords($rowb['modalidad'])."
						</td>	
...
<input name='sector' type='hidden' value='".$rowb['sector']."' />".$rowb['sector']."
						...
						<td class='BorderInfDch' width='150x'>
<input name='sector2' type='hidden' value='".$rowb['sector2']."' />".$rowb['sector2']."
						</td>	
												
						<td class='BorderInfDch' width='150x'>
<input name='modalidad' type='hidden' value='".$rowb['modalidad']."' />".$rowb['modalidad']."
						</td>	
