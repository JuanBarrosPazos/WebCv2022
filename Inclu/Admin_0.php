...
/**/
 ...
 $text_body = " <!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">
	...
	<table font-family='Times New Roman' width='90%' border='0' align='center' cellpadding='0' cellspacing='0'>
				<tr>
					<th colspan='3'>NOTIFICACIÓN DE INSTALACIÓN DE LA APLICACIÓN WEB CV</th>
				</tr>
				<tr>
	...
	$headers = array ('From' => "juanbarrospazos@hotmail.es",
				...
				$titulo= "NOTIFICACION DEL INSTALACIÓN DE WEB CV GRATUITA";
				...
				$mensaje= $texto_html;
			if( mail($destinatario, $titulo, $mensaje, $cabecera)){print("Se ha enviado");
							}else{print("No se ha enviado");}
	}
