...
function validate_form(){
	...
	elseif (strlen(trim($_POST['valor'])) < 3){
			...
			<table align='center' style=\"margin-top:10px\">
				...
				<tr>
					<th colspan=2 class='BorderInf'>
							...
							CREAR NUEVO SECTOR.
							<br/>
							Sus entradas en el CV podrán configurarse por dos tipos de sectores distintos.
							<br/>
							Y posteriormente filtrarse por los mismos criterios.
							<br />
							Cree los sectores necesarios para organizar correctamente sus entradas.
		...
		<input type='text' name='nombre' size=25 maxlength=22 value='".$defaults['nombre']."' />
				...
				<tr>
					<td align='right' valign='middle'  class='BorderSup' colspan='2'>
						<input type='submit' value='NUEVO SECTOR' />
