...
function show_form($errors=''){
	...
	print("<table align='center' style=\"border:0px;margin-top:4px\">
				<tr>
					<th colspan=3 width=100%>VER ESPECIALIDADES</th>
				</tr>
			<form name='todo' method='post' action='$_SERVER[PHP_SELF]' >
				<tr>
					<td align='center'>
						<input type='submit' value='VER ESPECIALIDADES' />
								...
								<tr>
									...
									<td class='BorderInf'>
										<form name='modifica' action='Crear.php' method='POST'>
											<input type='submit' value='CREAR NUEVA ESPECIALIDAD' />
										</form>
									</td>
								</tr>
								<tr>
									<th colspan=5 class='BorderInf'>SECTORES : ".$nunrows."</th>
								</tr>
								<tr>
		...
		while($rowb = mysqli_fetch_assoc($qb)){
			...
			elseif($rowb['valor'] != ''){	
					...
					print (	"<tr align='center'>
						...
						print("	<td class='BorderInf' align='center'>
