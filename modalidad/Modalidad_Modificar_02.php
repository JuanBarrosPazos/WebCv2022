...
function process_form(){
	...
	$sqlc = "UPDATE `$db_name`.`modalidad` SET `valor` = '$_POST[valor2]', `nombre` = '$_POST[nombre]' WHERE `modalidad`.`id` = '$_POST[id]' LIMIT 1 ";
	...
	$sqlc2 = "UPDATE `$db_name`.`web_cv` SET `modalidad` = '$_POST[valor2]' WHERE `web_cv`.`modalidad` = '$_POST[valor1]' ";
	...
	/************	MODIFICA EL NOMBRE EN MODALIDAD	*****************/
